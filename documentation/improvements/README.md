...
| [dual-role-accounts-plan.md](dual-role-accounts-plan.md) | **2026-07-25 plan**: header role switcher (welper ↔ customer) + customer→welper upgrade path, with recommended decisions (proposed, not started). |
