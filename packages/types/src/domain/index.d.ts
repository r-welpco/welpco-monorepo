...
export type BookingStatus = 'pending' | 'accepted' | 'in-progress' | 'completed' | 'cancelled' | 'declined';
export type PaymentStatus = 'authorized' | 'held' | 'released' | 'refunded' | 'failed';
/**
 ...
 */
export type DisputeStatus = 'open' | 'in-review' | 'under-review' | 'resolved' | 'dismissed' | 'closed' | 'escalated' | 'withdrawn';
